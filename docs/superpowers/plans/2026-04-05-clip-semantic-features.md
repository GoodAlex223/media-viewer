...
- [ ] **Step 1: Install @huggingface/transformers and ffmpeg-static**
...
- [ ] **Step 1: Add ffmpeg-static require in main.js**
...
- [ ] **Step 2: Add extractKeyframes IPC handler in main.js**
...
- [ ] **Step 1: Write the clip-worker.js file**
...
- [ ] **Step 1: Update DEFAULT_FEATURE_DIM in ml-model.js**
...
- [ ] **Step 2: Update ml-worker.js comment**
...
- [ ] **Step 3: Update existing unit tests for new dimension**
...
- [ ] **Step 2: Update loadFeatureCache() to load clipVector**
...
- [ ] **Step 3: Update saveFeatureCache() to save clipVector**
...
- [ ] **Step 4: Initialize clipCache in constructor**
...
- [ ] **Step 5: Update removeFileFromList() to clean clipCache**
...
- [ ] **Step 1: Add toggle HTML in index.html**
...
- [ ] **Step 2: Wire toggle in media-viewer.js constructor**
...
- [ ] **Step 3: Run the app to verify toggle appears**
...
- [ ] **Step 1: Add CLIP worker initialization**
...
- [ ] **Step 2: Add CLIP extraction helper method**
...
- [ ] **Step 3: Add video CLIP extraction method**
...
- [ ] **Step 4: Integrate into startBackgroundFeatureExtraction()**
...
- [ ] **Step 5: Update filter to check both caches**
...
- [ ] **Step 6: Run the app and test background extraction**
...
- [ ] **Step 1: Add feature concatenation helper**
...
- [ ] **Step 2: Update requestPredictionScores()**
...
- [ ] **Step 3: Update ML update calls (rating a file)**
...
- [ ] **Step 4: Update trainFromHistoricalRatings()**
...
- [ ] **Step 1: Add clip-worker.js ESLint block**
...
- [ ] **Step 1: Write E2E test for CLIP disabled via settings**
