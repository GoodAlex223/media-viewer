...
**PR #68 review round** (2026-09-12, after the branch was pushed on user direction): 5 findings + 2 below-threshold in round 1, all resolved in one wave; round 2 verified every one against the pushed revision (mutation-testing all three new guards), accepted both corrections to its own round-1 text, and left one residual, fixed below.
