...
**Follow-up tasks**: BACKLOG [2026-07-10] Group CW-P closeout follow-ups (🟤 CLI-layer regression tests; 🟡 pre-push friction re-evaluation after real use).
