...
**Last Updated**: 2026-05-28 <!-- PR #38 multi-agent review: 4 sub-threshold items (feature-cache local-capture, tournament-mode state-machine fallback, main-side single-flight, v2.0 visibility) -->
