...
| [G4 Strategic-Doc Refresh][] | Mechanical execution of the G4 spec: rewrite GOALS/ROADMAP/MILESTONES, sync CLAUDE.md to the pre-push E2E gate, install the weekly staleness check (Group G4) |
