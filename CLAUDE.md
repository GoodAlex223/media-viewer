...
- E2E code review cleanup (TASK-016, TASK-017 both completed): TASK-016 (clear setTimeout in closeApp, register CDN stub before firstWindow, remove unused waitForNotification export — PR #15); TASK-017 (fix stale JSDoc filename in electron-wrapper.cjs, update ESLint header comment to reflect 9 blocks — commit d82c53f)
