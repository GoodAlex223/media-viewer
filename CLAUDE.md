...
- E2E code review cleanup promoted to active tasks: TASK-016 (clear setTimeout in closeApp, register CDN stub before firstWindow, remove unused waitForNotification export); TASK-017 (fix stale JSDoc filename in electron-wrapper.cjs, update ESLint header comment to reflect 9 blocks)
